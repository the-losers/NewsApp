...
abstract class BaseDialogView : DialogFragment(), com.losers.news.ui.base.view.DialogMVPView {
    ...
    private fun getBaseActivity(): com.losers.news.ui.base.view.BaseActivity? {
